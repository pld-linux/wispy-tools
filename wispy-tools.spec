...
WiSPY-Tools to zbiór narzędzi o otwartych źródłach pozwalających na
dostęp do analizatora widma 2.4GHz WiSPY USB produkcji Metageek LLC
(http://www.metageek.net/).

Ten pakiet zawiera:
- WiSPY Curses - proste narzędzie oparte na Curses do rysowania
  wykresów danych z urządzenia WiSPY. DAne są pobierane w przestrzeni
  użytkownika poprzez libusb.
...
Ten pakiet zawiera:
- WiSPY GTK - narzędzie oparte na GTK+ do rysowania wykresów danych z
  urządzenia WiSPY. DAne są pobierane w przestrzeni użytkownika
  poprzez libusb. Interfejs WiSPY GTK jest zaprojektowany w oparciu o
  interfejs aplikacji Metageek pod Windows, ale jest trochę różnic.
